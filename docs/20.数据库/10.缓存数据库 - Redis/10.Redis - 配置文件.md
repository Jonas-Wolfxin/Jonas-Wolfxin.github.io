...
![image-20211226151527726](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226151529.png)

## include

![image-20211226151548208](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226151549.png)
...
![image-20211226151640216](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226151641.png)
...
![image-20211226151502217](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226151503.png)

### timeout

一个空闲的客户端维持多少秒会关闭，0 表示关闭该功能。即永不关闭。

![image-20211226151701798](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226151702.png)
...
![image-20211226151735808](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226151736.png)
...
![image-20211226152026984](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226152028.png)

### pidfile

存放 pid 文件的位置，每个实例会产生一个不同的 pid 文件。

![image-20211226152107994](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226152110.png)
...
![image-20211226152150127](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226152151.png)

### logfile

日志文件名称

![image-20211226152221350](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226152222.png)

### databases

设定库的数量 默认 16，默认数据库为 0，可以使用 `SELECT <dbid>`命令在连接上指定数据库 id。

![image-20211226152312056](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226152312.png)
...
![image-20211226152622972](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226152624.png)
...
![image-20211226152841729](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226152842.png)
...
![image-20211226153322688](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226153358.png)
...
![image-20211226154001167](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226154101.png)
...
![image-20211226153944767](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226153945.png)
...
![image-20211226154032551](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226154058.png)
...
![image-20211226154205172](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226154205.png)

## append only模式 

AOF 相关部分

![在这里插入图片描述](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226154227.png)

![在这里插入图片描述](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Redis/20211226154231.png)
