...
<img src="https://cdn.jsdelivr.net/gh/Jonas-Wolfxin/MyPicgo/img/202303181558612.png" alt="image-20230318155858388" style="zoom: 37%;" />
...
> ###### Trunk port: 
>
> - Trunk ports can carry multiple VLANs over a single interface; 用于**交换机之间**、**交换机和路由器之间**, **交换机和服务器**之间，它同时为多个(1-4094个，但除非使用扩展VLAN，否则最多为1005个)VLAN传输数据流。
>
...
-   allows **switches with each other** to negotiate the status of their switchports to be either **Access Ports** or **Trunk Ports**, instead of manual configuration.
...
>   ##### 补充1:
>
>   <img src="https://cdn.jsdelivr.net/gh/Jonas-Wolfxin/MyPicgo/img/202303230550406.png" alt="image-20230323055016098" style="zoom:36%;" />
>
...
>
>   <img src="https://cdn.jsdelivr.net/gh/Jonas-Wolfxin/MyPicgo/img/202303230606773.png" alt="image-20230323060653449" style="zoom: 45%;" />
...
>
>   4.   Test connectivity by ping command between PCs.  All PCs should be able to reach each other.
...
>   -   `default interface Interface_ID`: Reset an interface to its default configuration;
