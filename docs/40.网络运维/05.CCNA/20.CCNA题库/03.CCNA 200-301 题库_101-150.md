...
114. How does **CAPWAP** communicate between an **access point in local mode** and a **WLC**?
       ...
       <details>
        <summary>Correct Answer</summary>
           <strong>D</strong>
           <p><em>Explanation: </em></p>
           <p><img src="https://1.bp.blogspot.com/-zdVF4biZ6aI/XP9VQmYpY2I/AAAAAAAAIak/_H_O9Zi2gyoOtywSLl3BITQr7qluOJ49QCLcBGAs/s1600/Screenshot-2019-06-11-at-12.44.59-PM-ConvertImage.png" jsaction="load:XAeZkd;" jsname="HiaYvf" class="n3VNCb KAlRDb" alt="Cisco Access Point: SSID on Autonomous AP Configuration Example - Route XP  Private Network Services" data-noaft="1" style="width: 100%;"></p>
       </details>
