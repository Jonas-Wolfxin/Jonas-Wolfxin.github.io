...
date: 2022-07-18 17:40:11
permalink: /pages/e101f1/
categories:
  - 网络运维
  - CCNA
  - CCNA题库
...
354.   When a WLAN with WPA2 PSK is configured in the Wireless LAN Controller GUI which format is supported?
       ...
       <details>
        <summary>Correct Answer</summary>
           ...
           <a>https://www.cisco.com/c/en/us/td/docs/wireless/controller/8-2/config-guide/b_cg82/b_cg82_chapter_01010011.pdf</a>
       </details>
...
359.   What are two improvements provided by **automation for network management** in an SDN environment? (Choose two)
       ...
       E. Proprietary Cisco APIs leverage(利用) multiple network management tools.
       ...
       <details>
        <summary>Correct Answer</summary>
           ...
           <ul>
               ...
               <li>The Service Port is used for Out Of Bound (OOB) Management. Whilst the default configuration on the WLC allows for access via the management interface, it is better practice to have the service port configured on a different VLAN and use that to reach the WLC via SSH / HTTPS.</li>
...
379.   Refer to the exhibit. Which two commands, when configured on router R1, fulfill these requirements? (Choose two.)
       ...
       ![image-20220703184429211](C:\Users\Jonas Wolfxin\AppData\Roaming\Typora\typora-user-images\image-20220703184429211.png)
...
380.   When a **site-to-site VPN** is configured, which **IPsec mode** provides **encapsulation and encryption of the entire original IP packet**?
       ...
       <details>
        <summary>Correct Answer</summary>
           ...
           <a>https://www.firewall.cx/networking-topics/protocols/870-ipsec-modes.html</a>
           <br>
           <a>https://www.twingate.com/blog/ipsec-tunnel-mode/</a>
       </details>
...
383.   Refer to the exhibit. Which two prefixes are included in this routing table entry? (Choose two)
       ...
       <details>
        <summary>Correct Answer</summary>
           ...
           <em>Explanation: </em>
           <ul>
               <li>they use word "prefix" instead of usable addresses......</li>
           </ul>
       </details>

384.   ==Which two **primary drivers** support the need for **network automation**?==
       ...
       D. Providing a single entry point for resource provisioning
...
387.   Which HTTP status code is returned after a successful REST API request?
       ...
       <details>
        <summary>Correct Answer</summary>
           ...
           <em>Explanation: </em>
           <ul>
               <li><a>https://restfulapi.net/http-status-codes/#:~:text=201%20(Created),also%20be%20an%20appropriate%20response.</a></li>
           </ul>
       </details>
...
390.   Refer to the exhibit. Which action is taken by the router when a packet is sourced from 10.10.10.2 and destined for 10.10.10.16?
       ...
       ![image-20220703184851715](C:\Users\Jonas Wolfxin\AppData\Roaming\Typora\typora-user-images\image-20220703184851715.png)
...
394.   After installing a new **Cisco ISE server**, which task must the engineer perform on the Cisco WLC to connect wireless clients on a specific VLAN based on their credentials?
       ...
       <details>
           ...
           <a>https://www.techtarget.com/searchmobilecomputing/definition/Cisco-Identity-Services-Engine-ISE</a>
       </details>
...
396.   Refer to the exhibit. Router R4 is dynamically learning the path to the server. If R4 is connected **to R1 via OSPF Area 20**, *to R2 via R2 BGP*, and **to R3 via EIGRP 777**, which path is installed in the routing table of R4?
       ...
       <details>
        <summary>Correct Answer</summary>
           ...
           <a>https://www.geeksforgeeks.org/difference-between-ebgp-and-ibgp/#:~:text=EBGP%20stands%20for%20External%20Border,for%20Internal%20Border%20Gateway%20Protocol.&text=It%20runs%20between%20two%20BGP,in%20the%20same%20autonomous%20system.</a>
       </details>
