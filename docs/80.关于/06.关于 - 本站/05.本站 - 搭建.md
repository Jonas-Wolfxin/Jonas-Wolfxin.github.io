...
- `config.js` 添加内容：（记得看注释）
    ...
    ```js
    module.exports = {
        title: 'Jonas Wolfxin Blog',  // 首页居中标题
        ...
        head:[
            ...
            ['meta',{
                name: 'keywords',
                content: 'Jonas Wolfxin个人博客，VuePress搭建，学习Java、web、框架、微服务、工具、前端等相关知识',
            },
            ],
        ],
        themeConfig: {
...
- 在命令行运行项目
  ...
  ![image-20211031212255367](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/%E5%85%B3%E4%BA%8E/%E5%85%B3%E4%BA%8E%E6%9C%AC%E7%AB%99/20211031212407.png)
...
- 在 `nav.js` 里加入内容
    ...
    ![image-20211101103802945](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/%E5%85%B3%E4%BA%8E/%E5%85%B3%E4%BA%8E%E6%9C%AC%E7%AB%99/20211101103811.png)
