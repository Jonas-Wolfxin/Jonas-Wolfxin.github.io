...
![image-20211125005004035](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Docker/20211125005005.png)
...
- 配置 UTF-8 编码
    ...
    ![image-20211211231915077](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Docker/20211211231924.png)
...
- 进入 MySQL 容器，配置 UTF-8 编码
    ...
    ![image-20211211232140907](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Docker/20211211232142.png)
...
- 先简单启动，后在配置文件再连接 ES，重启生效
    ...
    ![image-20211125131216888](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Docker/20211125131225.png)
