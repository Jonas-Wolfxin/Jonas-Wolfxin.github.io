...
![1580461114467](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126004511.png)

Nginx 的官方下载网站为 <http://nginx.org/en/download.html>，当然你也可以之间在首页选中右边的 download 进入版本下载网页。在下载页面我们会看到如下内容：

![1580463222053](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126004515.png)
...
![1580610584036](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126005239.png)
...
![image-20211126155601288](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126155602.png)
...
![1585224061192](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126005243.png)
...
![](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126005251.png)
...
![1581419845687](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211130173056.png)
...
![1581419902873](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126005316.png)
...
![image-20211126145340927](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126145348.png)
...
![image-20211126145630109](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126145633.png)
...
![1581416861684](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126150404.png)
...
![1581416981939](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126150339.png)
...
![](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126145633.png)
...
![image-20211126150809349](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126150810.png)

yum 安装的配置信息查看：（这里截取 1.16.1 版本的 图片）

![1586016605581](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126151040.png)

可以看出 yum 安装的参数非常多，如果想源码简单安装也有这些参数，这涉及到源码复杂安装，往下看。

执行 `tar -zxvf nginx-1.16.1.tar.gz` 对下载的资源进行解压缩后，进入压缩后的目录，可以看到如下结构

![1581421319232](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126151024.png)
...
![1581439634265](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Nginx/20211126154503.png)
