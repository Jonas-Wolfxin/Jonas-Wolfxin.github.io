    ...
    init() {
      ...
      function drawRili() {
        ...
        if (EnMonth) {
          ...
          riliCtx.fillText(today + " th", 520, 38);
        } else {
          riliCtx.scale(1.1, 1);
      ...
      var iv = setInterval(() => {
        if (screen.complete && screenMask.complete) {
          screenImageCtx.drawImage(screen, -320, -50, 1280, 750);  // (screen, -300, -50, 1280, 720);
      ...
      // 奇妙的颜色变化
      var targetColor = { r: 80, g: 120, b: 169 };   // { r: 80, g: 120, b: 169 };
      ...
      function render() {
        ...
        ctx.fillStyle = "#0094FF"; // 时间的颜色 默认色 97adbb  蓝色 0094FF   绿色 9EFF00
