...
module.exports = [
  ...
  [
    {
      ...
      globalUIComponents: ["PageInfo", "BlockToggle", "GlobalTip", "Aplayer"] // 2.x 版本 globalUIComponents 改名为 clientAppRootComponentFiles
    }
  ],
  // 本地插件
  ...
  [
    'dynamic-title',
    {
      ...
      showText: 'ヾ(≧▽≦*)oWelcome back！',
      hideIcon: '/failure.ico',
      hideText: "ಥ_ಥ I miss you",
